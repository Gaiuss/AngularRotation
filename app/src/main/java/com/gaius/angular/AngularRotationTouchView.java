...
public class AngularRotationTouchView extends View {
    ...
    /**
     * AngularRotationTouchView的中心点坐标，相对于其父类布局而言的
     */
    ...
    /**
     * AngularRotationTouchView距离父类布局的左间距
     */
    private int mViewPaddingLeft;

    /**
     * AngularRotationTouchView距离父类布局的上间距
     */
    ...
    public AngularRotationTouchView(Context context) {
        this(context, null);
    }

    public AngularRotationTouchView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void obtainStyledAttributes(AttributeSet attrs) {
        ...
        framePadding = mTypedArray.getDimensionPixelSize(R.styleable.AngularRotationTouchView_framePadding, framePadding);
        frameWidth = mTypedArray.getDimensionPixelSize(R.styleable.AngularRotationTouchView_frameWidth, frameWidth);
        frameColor = mTypedArray.getColor(R.styleable.AngularRotationTouchView_frameColor, DEFAULT_FRAME_COLOR);
        mScale = mTypedArray.getFloat(R.styleable.AngularRotationTouchView_scale, DEFAULT_SCALE);
        mDegree = mTypedArray.getFloat(R.styleable.AngularRotationTouchView_degree, DEFAULT_DEGREE);
        controlDrawable = mTypedArray.getDrawable(R.styleable.AngularRotationTouchView_controlDrawable);
        deleteDrawable = mTypedArray.getDrawable(R.styleable.AngularRotationTouchView_deleteDrawable);
        controlLocation = mTypedArray.getInt(R.styleable.AngularRotationTouchView_controlLocation, DEFAULT_CONTROL_LOCATION);
        deleteLocation = mTypedArray.getInt(R.styleable.AngularRotationTouchView_deleteLocation, DEFAULT_DELETE_LOCATION);
        isEditable = mTypedArray.getBoolean(R.styleable.AngularRotationTouchView_editable, DEFAULT_EDITABLE);
...
//			deleteDrawable=getContext().getResources().getDrawable(R.drawable.ic_home_find_press);
//		}
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //获取AngularRotationTouchView所在父布局的中心点
    ...
    public void setImageDrawable(Drawable drawable) {
        if (drawable instanceof BitmapDrawable) {
            ...
            throw new NotSupportedException("AngularRotationTouchView not support this Drawable " + drawable);
        }
    }
